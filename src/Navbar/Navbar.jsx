      ...
      <Navbar color="faded" light expand="md" className="fixed-top navbar">
        <Nav className="container d-flex justify-content-around">
          ...
          <Collapse isOpen={isOpen} navbar>
            <Nav className="m-auto col-md-7 col-12 " navbar>
              <Nav className="w-100 d-flex  justify-content-between p-0 mt-0">
                <NavItem>
                  <Link to="/Home">
            ...
            <Nav className='d-flex '>
              ...
              {!user.currentUser && (
                <NavItem>
                  <Link to="/SignIn">
                    <NavLink className='navbar_items pl-2'> Sign in </NavLink>
                  </Link>
                </NavItem>
              )}
