            ...
            {store.cart.cartCounter ?
                <div className='container'>
                    <div className='d-md-flex justify-content-between  my-5'>
                        ...
                        <button onClick={checkingOut} className="col-12 col-md-2  col-sm-4 main_btn d-block ">Check Out</button>
                    </div>
                    ...
                    <div className='d-md-flex  justify-content-between align-items-center px-5 pt-3 mt-5'>
                        <button onClick={clearCart} className='sec_btn my-4 my-md-0 col-12 col-md-2 col-sm-4'>clear cart</button>
                        <h4 className=' text-right col-12 col-md-4 col-sm-4'>
                            Total amount =  <span style={{color:'var(--price-color)'}}>${store.cart.cartItems.reduce((prev, item) => {
                ...
                : <div><h3 className='section_title py-5'>Your card is empty</h3></div>}
        </div>
    )
